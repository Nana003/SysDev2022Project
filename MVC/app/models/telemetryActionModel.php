<?php
    ...
    class telemetryActionModel{
        ...
        public function createAction($data){
            ...
            $this->db->bind(':action_name', $data['action_name']);
        ...
        public function updateAction($data){
            $this->db->query("UPDATE telemetry_action SET action_name=:action_name, timestamp=:timestamp, ip_address=:ip_address, admin_id=:admin_id WHERE action_id=:action_id");
            $this->db->bind(':action_name', $data['action_name']);
            $this->db->bind(':timestamp', $data['timestamp']);
            $this->db->bind(':ip_address', $data['ip_address']);
            $this->db->bind(':admin_id', $data['admin_id']);
